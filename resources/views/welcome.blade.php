        ...
        <div class="login-right bg-primary w-50 h-100">
            <div class="row justify-content-center align-items-center w-100 h-100 border-3">
                <div class="d-flex justify-content-center">
                    <img class="m-3 position-absolute" src="{{ asset('/') }}/images/logosihadir.png" alt="" style="width: 150px;">
                </div>
                <div class="col-6 bg-body p-5 rounded-5">
                    @guest
                        <form action="{{ route('login') }}" method="post">
                            ...
                            <div class="input-group mb-3">
                                <input type="email" class="form-control form-control-lg bg-light fs-6" placeholder="Email Adress" name="email">
                            </div>
                    ...
                    @auth
                        <div class="input-group mb-5">
                            <a href="{{ url('/home') }}" class="btn btn-lg btn-primary w-100 fs-6">Dashboard</a>
                            <form action="{{ route('logout') }}" method="post">
                                @csrf
                                <button type="submit" class="btn btn-lg btn-primary w-100 fs-6">Log Out</button>
                            </form>
                        </div>
                    @endauth
                </div>
