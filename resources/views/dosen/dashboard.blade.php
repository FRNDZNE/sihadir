                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-widget widget-user">
                                    ...
                                    <div class="widget-user-image">
                                        <img class="img-circle elevation-2" src="{{ asset('/') }}/template/dist/img/user1-128x128.jpg" alt="User Avatar">
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 border-right">
                                                <div class="description-block">
                                                    ...
                                                    <span class="description-text">{{ $jadwal->semester->name."".$jadwal->kelas->name}}</span>
                                                </div>
                                                <!-- /.description-block -->
                                            </div>
                                            <div class="col-sm-4 border-right">
                                                <div class="description-block">
                                                    ...
                                                    <span class="description-text">mhs</span>
                                                </div>
                                                <!-- /.description-block -->
                                            </div>
                                            <div class="col-sm-4">
